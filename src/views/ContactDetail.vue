      ...
      <ion-content>
        <ion-list>
          ...
          <ion-item>
            ...
            <ion-input v-model="contact.email" placeholder="Enter email"></ion-input>
          </ion-item>
          <ion-item>
            <ion-label position="stacked">Phone</ion-label>
            <ion-input v-model="contact.phone" placeholder="Enter phone number"></ion-input>
          </ion-item>
        </ion-list>
        <ion-button expand="full" @click="updateContact">Save</ion-button>
        <ion-button expand="full" color="danger" @click="deleteContact">Delete</ion-button>
      </ion-content>
    </ion-page>
  </template>
